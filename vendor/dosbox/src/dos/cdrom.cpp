...
bool CDROM_Interface_SDL::SetDevice(char* /*path*/, int /*forceCD*/) { return false; }
...
bool CDROM_Interface_SDL::GetMediaTrayStatus(bool& mediaPresent, bool& mediaChanged, bool& trayOpen) {
	mediaPresent = mediaChanged = false;
	trayOpen = true;
	return true;
}
bool CDROM_Interface_SDL::PlayAudioSector(unsigned long /*start*/, unsigned long /*len*/) { return false; }
bool CDROM_Interface_SDL::PauseAudio(bool /*resume*/) { return false; }
bool CDROM_Interface_SDL::StopAudio(void) { return true; }
bool CDROM_Interface_SDL::LoadUnloadMedia(bool /*unload*/) { return false; }
